                    ...
                    <div className="registration-box">
                        <div className="row">
                            <div className="col-md-6 registration-left">
                                <h1>Rider Registation Form</h1>

                                <Link to="/learner"><Button variant="text">
                                        ...
                                        <Form onSubmit={handleloginSubmit} className="my-5">
                                            ...
                                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                                <InputGroup className="mb-3">
                                                    ...
                                                    <Form.Control type="hidden" name="userType" value="rider" placeholder="Enter Your Name" />
                                                </InputGroup>
                                            </Form.Group>
                                            ...
                                            <Form.Group className="mb-3" >
                                                <InputGroup className="mb-3">
                                                    <InputGroup.Text><FontAwesomeIcon icon={faKey} /></InputGroup.Text>
                                                    <Form.Control type="text" name="licence" onBlur={handleOnChange} placeholder="Driving Licence" />
                                                </InputGroup>
                                            </Form.Group>
                                            <Form.Group className="mb-3" >
                                                <InputGroup className="mb-3">
                                                    <InputGroup.Text><FontAwesomeIcon icon={faKey} /></InputGroup.Text>
                                                    <Form.Control type="text" name="area" onBlur={handleOnChange} placeholder="Area" />
                                                </InputGroup>
                                            </Form.Group>
                                            <Form.Group className="mb-3" >
                                                <InputGroup className="mb-3">
                                            ...
                                            <Form.Group className="mb-3" controlId="">
                                                ...
                                                <Form.Control as="textarea" name="carinfo"
                                                    placeholder="carinformation"
                                                    style={{ height: '100px' }} onBlur={handleOnChange} type="text" />
                                            </Form.Group>
